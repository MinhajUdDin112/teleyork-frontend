...
export default function ClearDeviceReport({setPage}) {
    ...
    return (
        <div className="card">
            <div className="card flex flex-wrap justify-content-between">
                <h5 style={{ paddingTop: "8px" }}>Clear Device Report</h5>
           ...
           <Button label="submit " className="mt-4"/> 
             ...
             <div style={{overflowY:"auto"}}>
              <DataTable className="mt-4" style={{minWidth:"1600px"}}>  
                  ...
                  <Column header="Total Uploaded Devices"/> 
                  <Column header="Total Success Devices"/>   
                  <Column header="Total Failure Devices"/> 
