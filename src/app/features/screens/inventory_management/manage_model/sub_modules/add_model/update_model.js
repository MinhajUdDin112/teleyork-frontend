...
import FileUploadTemplate from "./upload_file_template";
export default function AddModel({ agent,setNavigateToAddModel}) {  
    agent="Model"
    ...
    return (
        <>
            {agent === "" ? <h4 className="card font-semi-bold">Add Model</h4> : undefined}
            <Card >
                <div style={{ height: "79px" }} className="card flex flex-wrap justify-content-between">
                    ...
                    <div>
                        <Button label="View Batch Report" onClick={()=>{ 
