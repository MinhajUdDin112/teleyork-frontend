                ...
                <div>
                    ...
                    <div className="flex flex-wrap mb-3 justify-content-around ">
                        ...
                        <div className="mr-3 mb-3 mt-3">
                            ...
                            <InputText type="text" value={formik.values.loginid} name="loginid" onChange={formik.handleChange} onBlur={formik.handleBlur} className="w-20rem" />
                        </div>  
                        <div className="mr-3 mb-3 mt-3">
                            <p className="m-0">
                               Agent Company Name <span style={{ color: "red" }}>*</span>
                            </p>
