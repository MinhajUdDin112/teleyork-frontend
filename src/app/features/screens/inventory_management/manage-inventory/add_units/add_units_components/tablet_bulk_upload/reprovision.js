...
export default function TabletBulkUploadReprovision({permissions}) {
                ...
                <>
                    <p className="mt-4">
                        ...
                        {formik.values.carrier === "" ? (
                            ...
                            <a download={true} href="/images/addAndAssignNonActivateSim (1).xlsx" className="font-bold">
                                {" "}
                                &nbsp; (Sample file)
                            </a>
                        )}
