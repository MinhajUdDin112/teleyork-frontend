            ...
            {ProvisionType !== "Reprovision" ? (
                ...
                <div>
                    ...
                    <ul className="mt-4 ml-4">
                        <li className="mt-2">If MDN is found active in inventory it will be disconnected; reassigned and reactivated. If already disconnected it will be directly activated, in both cases with the zip codes that is uploaded in the file.
                          </li>
                        <li className="mt-2">Carrier can only be ; for TMB, once a SIM is used it cannot be re-provisioning.
                        </li>
                      <li className="mt-2"> Box and tracking numbers are auto generated by the system, however they can be edited.
                        </li>
                    <li className="mt-2">The system assumes that the ESN that will be uploaded will exist in inventory and not be associated with any active customer account. If the ESN is not inventory it can be added from Manage inventory => Add units => Add stock .
                      </li>
                    <li>Please do not upload the same ESN for
                        re-provisioning in less than 5 minutes.  
                        </li>
                     
                    </ul>   
                    <p className="mt-4">
                        <strong>Head : </strong>
                        ESN, Zipcode <strong>(Download Sample File)</strong>
                    </p>
                </div>
            )}
            <>
