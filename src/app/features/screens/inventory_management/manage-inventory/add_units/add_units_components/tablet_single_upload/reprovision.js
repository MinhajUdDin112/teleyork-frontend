...
export default function TabletSingleUploadReprovision({permissions,unit,model}) {
    let ref = useRef(null);
        ...
        if (Object.keys(formik.errors).length === 0) {
            ...
            Axios.post(`${BASE_URL}/api/web/tabletInventory/addReprovision`, obj)
                .then((res) => {
                    ...
                    formik.setFieldValue("provisionType", "Tablet Reprovision");
                    actions.resetForm();  
            ...
            <div>
                <div className="flex flex-wrap mb-3 justify-content-around ">
                    ...
                    <div className="mr-3 mb-3 mt-3">
                        ...
                        <InputText keyfilter="int" value={formik.values.Esn} maxLength={19} minLength={19} name="Esn" onChange={formik.handleChange} onBlur={formik.handleBlur} className="field-width mt-2" />
