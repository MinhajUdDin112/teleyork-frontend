...
import DialogForReject from "./Dialogs/DialogeFor_Reject"
import DialogForActivateSim from "./Dialogs/DialogeFor_Activate"
import { InputText } from "primereact/inputtext";
import { PrimeIcons } from "primereact/api";
import DialogeForRemarks from "./Dialogs/DialogeFor_Remarks";
import DialogeForTransferUser from "./Dialogs/DialogeFor_TransferUser";
import DialogeForRemarksForIJ from "./Dialogs/DialogeFor_RemaeksForIJ";
import { FilterMatchMode } from "primereact/api";
import { Dropdown } from "primereact/dropdown";

const BASE_URL = process.env.REACT_APP_BASE_URL;

const PrepaidEvaluatedEnrollments = () => {
    ...
    const getAllEnrollments = async () => {
        setIsLoading(true);
        try {
            const res = await Axios.get(`${BASE_URL}/api/user/prePostEvaluatedEnrollmentsList?userId=${parseLoginRes?._id}&accountType=Prepaid`);
                ...
                <div className="card mx-5 p-0 ">
                    <div className="flex font-bold pt-2">
                        <div className="mt-2 ml-2 pt-2 pl-1">
                            <h3>
                                <strong> Evaluated Enrollments</strong>
                            </h3>
                        </div>
...
export default PrepaidEvaluatedEnrollments
