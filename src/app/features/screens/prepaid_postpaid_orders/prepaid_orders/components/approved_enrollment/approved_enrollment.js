...
const PrepaidApproved_Enrollments = () => {
    ...
    const parseLoginRes = JSON.parse(loginRes);
     ...
     const getAllCompletedEnrollments = async () => {
        setIsLoading(true);
        try {
            const res = await Axios.get(`${BASE_URL}/api/user/approvedEnrollmentList?userId=${parseLoginRes?._id}&accountType=Prepaid`);
...
export default PrepaidApproved_Enrollments