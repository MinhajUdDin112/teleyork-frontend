            ...
            try {
                ...
                if (res.status === 200 || res.status === 201) {
                    ...
                    if(storedData){
                        ...
                        navigate(`/prepaid-selfresumeapplication`);
                    }
                    ...
                    <div className="card flex p-8">
                        <div className="col-6">
                            ...
                            <p className="mt-0 text-xl">
                                Eligibility can be determined by your participation in a government program or your income. If you are eligible for a government program, you may qualify for a discount on your ACP service.<br></br>If you are not eligible for a government program, you may still
                                qualify for a discount based on your income.<br></br>Additionally, you might qualify for ACP through another person, such as a parent or guardian, who is known as the Benefit Qualifying Person (BQP) for your ACP service..
                            </p>
                        </div>
                        <div className="col-6">
...
export default PrepaidSelfEligibility;
