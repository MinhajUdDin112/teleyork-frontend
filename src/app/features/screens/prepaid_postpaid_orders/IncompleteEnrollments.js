...
const IncompleteEnrollments = () => {
    ...
    return (
        <div className="card bg-pink-50">
            <div className="mx-5">
                <h3 className="text-xl font-semibold border-bottom-1 pb-2">List of Incomplete Enrollments</h3>
            </div>
            ...
            <div className="mx-5">
                ...
                <div className="">
                    <DataTable value={tableData} showGridlines resizableColumns columnResizeMode="fit">
                        ...
                        <Column header="Authorization Code" field="Authorization" resizeable={false} headerStyle={{ color: "black", fontWeight: "normal", fontSize: "small" }}></Column>
                        ...
                        <Column header="Enroll Date" field="Planname" resizeable={false} headerStyle={{ color: "black", fontWeight: "normal", fontSize: "small" }}></Column>
