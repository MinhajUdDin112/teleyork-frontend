                ...
                <div className="col-7">
                    <div className="card p-8 col-12 mx-0">
                        ...
                        <p className="mt-0 text-xl">
                            ...
                            for a qualifying program with the ACP Administrator. The information shared by the state or Tribal government will be used only to help find out if I can get an ACP benefit.<br></br>I acknowledge and consent to the enrollment or transfer of my services with {companyName}, Inc for
                            the Affordable Connectivity Program (ACP) and I understand that I cannot receive multiple ACP program benefits concurrently from the same or different providers.<br></br>All the answers and agreements that I provided on this form are true and correct to the best of my
                            knowledge. I know that willingly giving false or fraudulent information to get ACP benefits is punishable by law and can result in fines, jail time, de-enrollment, or being barred from the program.
                        </p>
