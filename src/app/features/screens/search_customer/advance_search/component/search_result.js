       ...
       <div className="mt-4"> 
            ...
            <DataTable
                        ...
                        >
                            ...
                            ></Column>
                            <Column header="Enrollment Type" field="enrollment"  
                                body={(rowData) =>(
                                     rowData?.isSelfEnrollment ? <p>Self Enrollment</p>:<p>Enrollment</p>      
     ) }
                              ></Column>
                            <Column header="Name" field="name" body={(rowData)=>(
                            ...
                            <Column field="createdAt" header="Created At" body={(rowData) =>
