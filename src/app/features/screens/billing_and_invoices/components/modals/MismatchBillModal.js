...
const MismatchBillModal = ({ misMatchBillModal, setMisMatchBillModal }) => {
    ...
    return (
        <div>
            <Dialog header="Add Mismatch Bill Pay" headerStyle={{ borderBottom: "1px solid #c5c5c5", paddingLeft: "35px" }} closable={false} visible={misMatchBillModal} footer={renderFooter()} style={{ width: "50vw" }}>
                <div className="m-3">
                    <div className="flex">
