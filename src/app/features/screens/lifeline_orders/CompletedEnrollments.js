...
const CompletedEnrollments = () => {
    ...
    return (
        <div className="card bg-pink-50">
            ...
            <div className="mx-5">
                <h3 className="text-xl font-semibold border-bottom-1 pb-2">Completed Enrollments</h3>
            </div>
            ...
            <div className="mx-5">
                ...
                <div className="">
                    <DataTable showGridlines resizableColumns columnResizeMode="fit">
                        ...
                        <Column header="ESN" field="EsnNumber" resizeable={false} headerStyle={{ color: "black", fontWeight: "normal", fontSize: "small" }}></Column>
                        <Column header="MDN" field="MdnNumber" resizeable={false} headerStyle={{ color: "black", fontWeight: "normal", fontSize: "small" }}></Column>
                        ...
                        <Column header="Commission" field="Commission" resizeable={false} headerStyle={{ color: "black", fontWeight: "normal", fontSize: "small" }}></Column>
