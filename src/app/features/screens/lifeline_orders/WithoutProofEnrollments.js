...
const WithoutProofEnrollments = () => {
    ...
    return (
        ...
        <div className="mx-5">
                <h3 className="text-xl font-semibold border-bottom-1 pb-2">WithOut Proof Enrollment</h3>
            </div>
            ...
            <div className="flex flex-wrap mx-3 my-3">
                <div className="mb-3 mr-3">
                    ...
                    <Calendar id="range" value={dateRange} onChange={(e) => setDateRange(e.value)} showIcon selectionMode="range" readOnlyInput style={{ width: "23rem" }} />
                </div>
                <div className="mb-3 mr-3">
